...
import {
  ourFocusData,
  headLineContent,
} from "../../shared/resources/textData/TextData";
      ...
      <Grid container className={classes.root}>
        ...
        <Grid container spacing={2} className={classes.trackerBackground}>
          ...
          <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <Typography className={classes.h5MediumWhite}>
          ...
          <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <Typography className={classes.h5MediumWhite}>
                Number of organisations we have assisted
              </Typography>
            </Grid>
          </Grid>
        </Grid>
        <Grid container justify={"space-around"} spacing={3}>
          <Grid item xs={12}>
            <Typography className={classes.h1BoldEbony}>Our Focus</Typography>
          </Grid>
                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography className={classes.labelManatee}>
                      {!focus.readMore
                        ? focus.subHeading.substr(0, 90).concat(". . .")
                        : focus.subHeading}
                    </Typography>
                  </CardContent>
                </CardActionArea>
