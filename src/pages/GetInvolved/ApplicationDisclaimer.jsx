                ...
                <Grid container className={classes.root}>
                    <Grid item xs={12} >
                        <Grid container spacing={3} style={{padding:"20px"}}>
                            <Grid item xs={12}>
                                <Typography className={classes.h1BoldEbony}>Dear Potential Volunteer,</Typography>
                            </Grid>
                            <Grid item xs={12}>
                            ...
                            <Grid item xs={12}>
                                <Typography className={`${classes.highlight} ${classes.h5MediumEbony}` } >Please Note:</Typography>
                                <ul>
                                    <li>
                                        <Typography className={`${classes.h5MediumEbony}` }>
