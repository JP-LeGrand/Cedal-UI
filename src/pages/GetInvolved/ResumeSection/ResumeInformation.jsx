...
function ResumeInformation(props) {
  ...
  function validateIdentification() {
    ...
    let sectionIsValid =
      identificationChildRef?.validateIdentification() ?? false;
    if (sectionIsValid) {
  ...
  const getStepContent = (index) => {
    switch (index) {
      ...
      case 1:
        return (
          <Identification resumeInformationRef={setIdentificationChildRef} />
        );
      default:
        return null;
    }
...
const mapDispatchToProps = (dispatch) => {
  return {
    saveResumeInformation: bindActionCreators(
      VolunteerActions.SaveResumeInformation,
      dispatch
    ),
  };
};
