...
function BasicInformation(props) {
  ...
  const validateBasicInformation = () => {
    ...
    let driversLicenceErrorMessage,
      disabilitiesDetailsErrorMessage,
      vehicleErrorMessage,
      disabilitiesErrorMessage;
      ...
      <Grid item xs={12}>
        <FormControl noValidate autoComplete="off">
          <Grid item xs={12}>
            <FormLabel
              component="legend"
              className={state.driversLicenceError ? classes.error : ""}
            >
            ...
            <FormHelperText className={classes.error}>
              {state.driversLicenceErrorMessage}
            </FormHelperText>
          </Grid>
          <Grid item xs={12}>
            <FormLabel
              component="legend"
              className={state.vehicleError ? classes.error : ""}
            >
              Do you own a car?
            </FormLabel>
            <RadioGroup
            ...
            <FormHelperText className={classes.error}>
              {state.vehicleErrorMessage}
            </FormHelperText>
          </Grid>
          <Grid item xs={12}>
            <FormLabel
              component="legend"
              className={state.disabilitiesError ? classes.error : ""}
            >
            ...
            <FormHelperText className={classes.error}>
              {state.disabilitiesErrorMessage}
            </FormHelperText>
          </Grid>
        </FormControl>
