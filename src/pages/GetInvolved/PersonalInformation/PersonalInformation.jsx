...
function getSteps() {
  return ["Biographical Information", "Basic Information", "Address Details"];
}
...
function PersonalInformation(props) {
  ...
  const [
    ...
    setBiographicalInformationChildRef,
  ] = useState({});
  ...
  function validateBiographicalInformation() {
    ...
    let sectionIsValid =
      biographicalInformationChildRef?.validateBiographicalInformation() ??
      false;
    if (sectionIsValid) {
  ...
  function validateBasicInformation() {
    ...
    let sectionIsValid =
      basicInformationChildRef?.validateBasicInformation() ?? false;
    if (sectionIsValid) {
  ...
  function validateAddressDetails() {
    ...
    let sectionIsValid =
      addressDetailsChildRef?.validateAddressDetails() ?? false;
    if (sectionIsValid) {
      ...
      case 0:
        return (
          <BiographicalInformation
            personalInformationRef={setBiographicalInformationChildRef}
          />
        );
      case 1:
        return (
          <BasicInformation
            personalInformationRef={setBasicInformationChildRef}
          />
        );
      case 2:
        return (
          <AddressDetails personalInformationRef={setAddressDetailsChildRef} />
        );
      default:
        return null;
    }
...
const mapDispatchToProps = (dispatch) => {
  return {
    savePersonalInformation: bindActionCreators(
      VolunteerActions.SavePersonalInformation,
      dispatch
    ),
  };
};
